...
var (
	...
	fullMaxForkAncestry  uint64 = params.FullImmutabilityThreshold[0]  // Maximum chain reorganisation (locally redeclared so tests can reduce it)
	lightMaxForkAncestry uint64 = params.LightImmutabilityThreshold[0] // Maximum chain reorganisation (locally redeclared so tests can reduce it)
